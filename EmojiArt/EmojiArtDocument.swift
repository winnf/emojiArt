...
class EmojiArtDocument: ObservableObject, Hashable, Identifiable {
    ...
    //need this for equatability
    static func == (lhs: EmojiArtDocument, rhs: EmojiArtDocument) -> Bool { // == is the name of the function
        lhs.id == rhs.id
    }
    ...
    @Published var steadyStateZoomScale: CGFloat = 1.0 //how much we're zoomed in/out in our documents
